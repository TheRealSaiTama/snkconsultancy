              ...
              <div className="relative">
                ...
                <div className="relative bg-white rounded-2xl p-6 shadow-lg border border-slate-200/60">
                  <div className="relative aspect-[4/5] rounded-xl overflow-hidden bg-slate-100">
                    <Image
                      src="/sohanattri.jpeg"
                      alt="Sohan Attri - Founder & CEO, SNK Overseas"
                      fill
                      priority
            ...
            >
              ...
              <div className="space-y-4">
                <p className="text-lg text-slate-700 leading-relaxed">
                  With over a decade of distinguished experience in international recruitment and global workforce solutions, Sohan Attri has established SNK Overseas as a premier consultancy connecting exceptional talent with world-class opportunities.
                </p>
                <p className="text-lg text-slate-700 leading-relaxed">
                  His strategic vision and commitment to excellence have transformed thousands of careers while building lasting partnerships with leading organizations across 20 countries. Under his leadership, SNK Overseas has become synonymous with integrity, quality, and results in the international placement industry.
                </p>
              </div>
